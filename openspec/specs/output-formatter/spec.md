...
Provides shared output format selection and per-domain formatter modules (task, backlog, portfolio) that render data in the requested output format, replacing ad-hoc inline formatting in handlers.
