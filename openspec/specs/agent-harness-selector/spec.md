# Spec: Agent Harness Selector

## Purpose

Provides a module responsible for selecting the correct `IAgentHarness` implementation based on the configured protocol string, encapsulating all protocol dispatch logic away from `Program.fs`.
